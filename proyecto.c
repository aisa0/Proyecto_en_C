...
static GtkButton *statusClick,*gameClick; //*diffClick,
...
//ESTA SECCION ES LA QUE SE ENCARGA DEL BOTON GAMEMODE
/*
...
//ESTA SECCION SE ENCARGA DEL MODO DE JUEGO PVP
...
//ESTA SECCION SE ENCARGA DEL MODO DE JUEGO PVC
/*
...
//ESTA SECCION SE ENCARGA DE LAS DIFICULTADES DEL JUEGO
/*
...
void on_statusButton_clicked(GtkWidget *click_button, gpointer   user_data)
{
  ...
  if(!flag)
    {
      gtk_button_set_label(statusClick, "Jugando"); //Seleccione Modo de Juego
      statusFlag=1;
      //gameClick = (GtkButton *) user_data;
      gameType = 1;
      //if(!statusFlag) return;
...
//ESTA SECCION SE ENCARGA DE LA LOGICA EN EL TABLERO
...
// ESTA SECCION GENERA UN NUMERO ALEATORIO
/*
